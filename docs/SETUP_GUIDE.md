...
- 리뷰 로직은 `your-org/senior-reviewer` 레포에서 중앙 관리됩니다.
...
- [ ] `[수동]` `senior-reviewer` 레포 → Settings → Actions → General → Access → **"Accessible from repositories in the 'your-org' organization"** 활성화
...
- [ ] YAML 문법이 유효함
- [ ] `uses:` 경로가 `your-org/senior-reviewer/.github/workflows/review-executor.yml@main`과 정확히 일치
